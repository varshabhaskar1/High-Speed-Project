...
# DVE full session
# Saved on Mon Apr 24 21:16:28 2017
# Designs open: 1
#   Sim: /home/ecelrc/students/tchouhan/highspeed/simv
...
#<Session mode="Full" path="/home/ecelrc/students/tchouhan/highspeed/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{59 52} {775 758}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 172} {height 369} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 172} {height 369} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 716} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/ecelrc/students/tchouhan/highspeed/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/ecelrc/students/tchouhan/highspeed -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { wallace.out wallace.a wallace.b }
...
# Restore C1 time
gui_set_time -C1_only 113357910000
...
catch {gui_list_select -id ${Hier.1} {wallace}}
...
gui_list_show_data -id ${Data.1} {wallace}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {wallace.out wallace.a wallace.b }}
...
gui_open_source -id ${Source.1}  -replace -active wallace /home/ecelrc/students/tchouhan/highspeed/top4.v
